...
Due to limitations of time and scope, the large-scale suggestions provided by the reviewers were deemed too ambitious to implement. However, there were several bugs revealed through the testing that we were able to fix before the final project submission. Such bugs include a bug related to (https://github.com/GavinCartier/rock-paper-chess/commit/9b621404409241a1d8c8a71efd05e88dd0a48e3b)[king check detection not working properly], a glitch related to the (https://github.com/GavinCartier/rock-paper-chess/commit/4da5cf1bbb702274e2715e4e28a5093256b29733)[rook location not updating properly when castling], and a bug where (https://github.com/GavinCartier/rock-paper-chess/commit/b52ae2de1fc07a2c960ea722d66421b9c3d6277d)[health bar displays for promoted pawns were not updating properly]. 
